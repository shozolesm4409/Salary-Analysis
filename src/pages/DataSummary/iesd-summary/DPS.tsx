            ...
            <table className="w-full text-left border-collapse">
              <thead className="sticky top-0 z-20 bg-slate-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-xs font-black text-slate-700 uppercase border border-slate-200 bg-slate-50 min-w-[150px]">Name</th>
                  {allMonths.map(month => (
                  ...
                  <th className="px-4 py-3 text-xs font-black text-slate-700 uppercase border border-slate-200 bg-slate-50">Remark</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {categories.map((cat, idx) => (
                  <tr key={cat} className="hover:bg-blue-50/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm border border-slate-100"></td>
                  </tr>
                ))}
              </tbody>
            </table>
